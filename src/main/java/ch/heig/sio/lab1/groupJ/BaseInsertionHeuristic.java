...
/**
 * Classe abstraite qui fournit les éléments communs à plusieurs heuristiques d'insertion pour le problème TSP.
 * Cette classe gère l'initialisation du tour et l'insertion progressive des villes, tout en permettant
...
public abstract class BaseInsertionHeuristic implements ObservableTspConstructiveHeuristic {
    ...
    public TspTour computeTour(TspData data, int startCityIndex, TspHeuristicObserver observer) {
        int n = data.getNumberOfCities();  // Nombre total de villes.
        List<Integer> tour = new ArrayList<>();  // Liste représentant les villes dans la tournée.
        tour.add(startCityIndex);  // On commence la tournée avec la ville de départ donnée.
